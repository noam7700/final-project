...
//	 */
	 ...
	 public List<Basket> getSavedBaskets() throws UnexpectedException {
	 ...
	 public List<ProductInfo> getProductsData() throws UnexpectedException {
		  ...
		  try {
			   Products productsRetrieval = (Products) products;
			   return productsRetrieval.getProducts();
		  } catch (Exception e) {
			   throw new UnexpectedException("Unexpected response from server");
		  }
	 }
