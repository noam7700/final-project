...
//
//	 public DbProduct(String id, String name, Text ingredientsText, Category categoryRelatedTo, double price) {
//		  this.id = id;
//		  this.name = name;
...
public class DbProduct {
    ...
    DbProduct(String id_str, String price_str, String desc, String supplier_desc, String price_perunit_str, String img_src) {
        this.id_str = id_str;
    ...
    protected DbProduct(BufferedReader in) throws IOException {
        id_str = in.readLine();
